...
def seed_db(db: Session):
    ...
    # ── Classes ──────────────────────────────────────────────────────────
    classes_data = [
        ClassSession(id="cls-1", title="Junior Beginners Clinic", type="junior-clinic", level="beginner", day_of_week="Monday", start_time="4:00 PM", end_time="5:30 PM", start_date="2026-04-01", end_date="2026-12-15", min_age=6, max_age=12, current_students=6, price=35, description="A fun introduction to tennis for kids ages 6-12. Learn basic strokes, footwork, and court positioning."),
        ClassSession(id="cls-2", title="Adult Intermediate Clinic", type="adult-clinic", level="intermediate", day_of_week="Tuesday", start_time="7:00 PM", end_time="8:30 PM", start_date="2026-04-01", end_date="2026-12-15", min_age=18, max_age=100, current_students=4, price=45, description="For players who can rally consistently. Focus on strategy, point construction, and shot selection."),
        ClassSession(id="cls-4", title="Junior Advanced Clinic", type="junior-clinic", level="advanced", day_of_week="Thursday", start_time="5:00 PM", end_time="6:30 PM", start_date="2026-04-01", end_date="2026-12-15", min_age=10, max_age=17, current_students=5, price=40, description="Competitive juniors ready for tournament play. Advanced drills, match strategy, and mental toughness."),
        ClassSession(id="cls-5", title="Adult Beginners Clinic", type="adult-clinic", level="beginner", day_of_week="Saturday", start_time="10:00 AM", end_time="11:30 AM", start_date="2026-04-01", end_date="2026-12-15", min_age=18, max_age=100, current_students=3, price=35, description="Never held a racquet? No problem! Learn the fundamentals in a supportive, no-pressure environment."),
        ClassSession(id="cls-6", title="Junior Ball Machine Clinic", type="junior-clinic", level="beginner", day_of_week="Friday", start_time="4:00 PM", end_time="5:00 PM", start_date="2026-04-01", end_date="2026-12-15", min_age=6, max_age=14, current_students=2, price=30, description="Groove your strokes with our ball machine. Repetition builds muscle memory and consistency for juniors."),
    ]
