        ...
        <div className="text-center mb-6">
          ...
          <div className="mt-4">
            <div className="mx-auto mb-3">
              <img src="/HGIghew.jpg" alt="Gina's Tennis World" className="h-16 w-auto mx-auto rounded-lg" />
            </div>
                ...
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                  <div className="bg-white rounded-2xl p-6 max-w-lg w-full max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="text-sm text-gray-700 space-y-3">
                      ...
                      <p><strong>4. Attendance</strong><br />You are responsible for showing up to all scheduled classes on time. If you cannot attend, you must notify Gina ahead of time so the instructor can adjust the lesson plan. If you miss a class without prior notice, a make-up class will not be offered.</p>
